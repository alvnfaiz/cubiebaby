        ...
        <div class="md:container flex flex-row justify-between mx-auto">
            ...
            <div class="flex flex-row items-center space-x-2">
                <div class="flex flex-row">
                    <form action="{{ route('search') }}" method="GET" class="flex flex-row">
                        <div class="hidden relative mr-3 md:mr-0 md:block">
                            ...
                            <input type="text" id="email-adress-icon" name="search"
                                class="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Search...">
                        </div>
                    </form>
                </div>
                @if (auth()->user())
                    ...
                    <button class="p4 text-blue-600  focus:outline-none focus:shadow-outline"
                    ...
                    <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow "
                        ...
                        <div>
                            ...
                            <span
                                class="block text-sm font-medium text-gray-500 truncate pb-2 px-4">{{ auth()->user()->email }}</span>
                            @if (auth()->user()->role != 'Member')
                                <a href="{{ route('dashboard') }}"
                                    class="block py-2 px-4 text-sm text-blue-500 hover:bg-blue-700 hover:text-white"
                                    data-dropdown-toggle="dropdown-user">
                                    Admin Area</a>
                            @endif
                        </div>
...
<footer class="p-4  sm:p-6 bg-gray-800">
    <div class="md:flex md:justify-between container mx-auto max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="flex flex-col">
            <div class="mb-6 md:mb-0 flex">
                <a href="{{ route('home') }}"
                    class="text-lg font-semibold tracking-widest text-white uppercase text-white focus:outline-none focus:shadow-outline border-b-2 border-white">CubieBaby</a>
            </div>
            <span class="text-white text-sm">
                Jln Katumanggungan Pasar Papan, Batusangkar, Sumatera Barat, Indonesia(27280)
            </span>
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h3 class="mb-6 text-sm font-semibold uppercase text-white">Owner</h3>
                <ul>
                    <li class="mb-4">
                        <a href="https://flowbite.com" target="_blank"
                            class=" hover:underline text-gray-400">Melly</a>
                    </li>
                    
                </ul>
            </div>
            <div>
                <h3 class="mb-6 text-sm font-semibold  uppercase text-white">Follow us</h3>
                <ul>
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" target="_blank"
                            class=" hover:underline text-gray-400">Instagram</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" target="_blank"
                            class=" hover:underline text-gray-400">Facebook</a>
                    </li>
                </ul>
            </div>
            <div>
                <h3 class="mb-6 text-sm font-semibold text-white uppercase text-white">Legal</h3>
                <ul>
                    <li class="mb-4">
                        <a href="#" target="_blank" class=" hover:underline text-gray-400">Privacy
                            Policy</a>
                    </li>
                    <li>
                        <a href="#" target="_blank" class=" hover:underline text-gray-400">Terms &amp;
                            Conditions</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center text-gray-400">© 2022 <a href="https://flowbite.com"
                target="_blank" class="hover:underline">CubieBaby™</a>. All Rights Reserved.
        </span>
