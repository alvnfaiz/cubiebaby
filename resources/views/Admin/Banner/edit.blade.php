                        ...
                        <div class="sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                                <div class="col-span-3 sm:col-span-2">
                                    ...
                                    <div class="mt-5">
                                        <img src="{{ asset('storage/'.$banner->image) }}" alt="" class="w-full">
                                    </div>
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="flex mt-1 shadow-sm">
                                            <input value="{{ old('alt_text', $banner->alt_text) }}" type="text" name="alt_text" id="alt_text" class="flex-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Nama Banner">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-3 sm:col-span-2">
                                    <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
                                    <input type="radio" value="active" name="status" @if(old('status', $banner->status) == 'active') checked @endif>
                                    <label for="status" class="ml-2">Active</label>
                                    <input type="radio" value="inactive" name="status" @if(old('status', $banner->status) == 'inactive') checked @endif>
