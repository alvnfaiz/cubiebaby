                        ...
                        <div class="sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="flex mt-1 shadow-sm">
                                            <input value="{{ old('alt_text', $banner->alt) }}" type="text"
                                ...
                                <div class="col-span-3 sm:col-span-2 flex flex-col">
                                    ...
                                    <label class="ml-2"><input type="radio" value="active" name="status"
                                            @if (old('status', $banner->status) == 'Active') 
                                                checked 
                                            @endif>
                                        Active</label>

                                    <label class="ml-2"><input type="radio" value="inactive" name="status"
                                            @if (old('status', $banner->status) == 'Inactive') 
                                                checked 
                                            @endif>
                                        Inactive</label>
                                    @error('status')
